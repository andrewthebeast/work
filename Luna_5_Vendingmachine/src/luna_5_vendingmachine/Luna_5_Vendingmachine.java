...
public class Luna_5_Vendingmachine {
    ...
    public static void main(String[] args) {
        ...
        candies.add(candy1);
        Candies candy2 = new Candies("Snickers", 8, 1.25, 280);
        candies.add(candy2);
        Candies candy3 = new Candies("Hersheys", 8, 1.00, 230);
        candies.add(candy3);
        Candies candy4 = new Candies("Twix", 8, .75, 286);
        candies.add(candy4);
        Candies candy5 = new Candies("Almond Joy", 8, .75, 243);
        candies.add(candy5);
        Candies candy6 = new Candies("Kit Kat", 8, 1.00, 218);
        candies.add(candy6);
        Candies candy7 = new Candies("Starburst", 8, .75, 160);
        candies.add(candy7);
        Candies candy8 = new Candies("M&M's", 8, 1.25, 230);
        candies.add(candy8);
        Candies candy9 = new Candies("100 Grand", 8, .90, 201);
        candies.add(candy9);
        candiesMaker();
    } 
    public static void candiesMaker(){
        ...
        for (int i = 0; i < machine.length; i++) {
            for (int j = 0; j < machine.length; j++) {
                System.out.print(candies.get(i).getName());
            }
        }
