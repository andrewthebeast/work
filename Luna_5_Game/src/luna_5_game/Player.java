...
public class Player {
    ...
    public Player() throws SlickException {
        SpriteSheet runningSS = new SpriteSheet("res/Agent151", 64, 64, 0);
        //animation to make the player move up
        up = new Animation();
        ...
        //animation to make the player move down
        down = new Animation();
        ...
        //animation to make the player move left
        left = new Animation();
        ...
        //animation to make the player move right
        right = new Animation();
        ...
        //animation to make the player wait
        wait = new Animation();
